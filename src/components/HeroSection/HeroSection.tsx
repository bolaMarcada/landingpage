    ...
    <section className="hero" id="inicio">
      ...
      <div className={`hero-container ${isVisible ? 'visible' : ''}`}>
        <div className="hero-logo-container">
          <img src={logo} alt="Logotipo Bola Marcada" className="logo-image fade-in" />
        </div>

        <div className="hero-content-wrapper">
          <div className="hero-left">
            <h1 className="hero-slogan slide-up">
              <span className="highlight">Quem marca,</span> joga.
              <br />
          ...
          <div className="hero-right">
            <div className="mascot-container float-animation">
              ...
              <img src={avatar} alt="Mascote Bola Marcada" className="mascot-image" />
            </div>
