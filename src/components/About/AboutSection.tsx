      ...
      <div className={`about-container ${isVisible ? 'fade-in' : ''}`}>
        ...
        <div className="about-metrics">
          <div className="metric-card">
            ...
            <div className="metric-number" data-count="1200">
              +1.200
            </div>
          ...
          <div className="metric-card">
            ...
            <div className="metric-number" data-count="800">
              +800
            </div>
          ...
          <div className="metric-card">
            <div className="metric-icon">🧑‍💼</div>
            <div className="metric-number" data-count="150">
              +150
            </div>
          ...
          <div className="metric-card">
            <div className="metric-icon">⚽</div>
            <div className="metric-number" data-count="3500">
              +3.500
            </div>
